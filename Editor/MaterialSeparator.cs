...
public class MaterialSeparator : EditorWindow
{
    ...
    [MenuItem("Mesh+Bones/Mesh Splitter by Material using Mask")]
    static void Init()
    {
    ...
    void OnGUI()
    {
        ...
        materialID = EditorGUILayout.Popup("Select Submesh Target Material", materialID, subMeshNames);
        maskMap = (Texture2D)EditorGUILayout.ObjectField("Mask Texture: white: copy, black: separate", maskMap, typeof(Texture2D), false);
